...
int main()
{
    ...
    switch (case_value)
    {
    case 1: a=Add(value1,value2);printf("和为：%lf\n",a) ;system("pause");break;
    case 2: b=Minus(value1,value2);printf("差为：%lf\n",b);system("pause");break;
    case 3: c=Divide(value1,value2);printf("商为：%lf\n",c);system("pause");break;
    case 4: d=Multipy(value1,value2);printf("积为：%lf\n",d);system("pause");break;
    default:exit(0);
        break;
    }
 }
